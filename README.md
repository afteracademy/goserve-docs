...
![goserve](./public/images/goserve-banner.png)
...
- **Article**: [How to Architect Good Go Backend REST API Services](https://afteracademy.com/article/how-to-architect-good-go-backend-rest-api-services)
...
**Built with ❤️ by [AfterAcademy](https://afteracademy.com)**

⭐ Star the [goserve framework](https://github.com/afteracademy/goserve) if you find it helpful!
